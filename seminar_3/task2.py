...
print(f"kолличество документов с фатальным исходом до 6 мес: {collection.count_documents(query)}")

query = {'properties.month': {'$gte': '6'}}
print(f"kолличество документов с фатальным исходом более 6 мес : {collection.count_documents(query)}")
